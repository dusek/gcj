...
Each problem is solved in directory gcj/problems/round<N>/<ABC>/<problem-letter>.py,
...
I.e., to solve problem B from Round 1C, run:
gcj/bin/solve round1.C B <testcase-input-file-path>

To solve problem A from Round 3, run:
gcj/bin/solve round3 A <testcase-input-file-path>
